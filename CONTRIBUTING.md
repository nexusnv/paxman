...
[ADR-0008](docs/adr/0008-license-decision.md) and the
[license decision spec](docs/specs/license-decision.md)). We
...
- **Subsystem boundary rules** are enforced by `import-linter`. See
  [pyproject.toml](pyproject.toml) for the full contract.
...
GitHub issue**. See
[SECURITY.md §7](SECURITY.md) for the vulnerability disclosure
...
- [EXTENDING.md](EXTENDING.md) — adding a new contract adapter,
  capability, or inference provider.
- [docs/adr/README.md](docs/adr/README.md) — the ADR index and
  template.
- [SECURITY.md](SECURITY.md) — vulnerability reporting.
- [TESTING_STRATEGY.md](TESTING_STRATEGY.md) — test strategy and
  patterns.
