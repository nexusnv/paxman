...
> **Related docs:** [ARCHITECTURE.md §15 Extension Model](./ARCHITECTURE.md), [PACKAGE_STRUCTURE.md §15 Public Protocols](./PACKAGE_STRUCTURE.md), [GLOSSARY.md](./GLOSSARY.md)
...
- **Assign confidence.** Capabilities return candidates; the Reconciler assigns confidence. See [ADR-0005](./docs/adr/0005-confidence-ownership.md).
...
Custom heuristics require an ADR (see [docs/adr/](./docs/adr/)).

---

## 5. Testing Your Extension

See [TESTING_STRATEGY.md](./TESTING_STRATEGY.md) for the test strategy. Specifically:
...
The Paxman core team accepts extensions into the main package **only by ADR** (see [docs/adr/](./docs/adr/)). For everything else, publish your extension as a separate PyPI package:
...
- [PACKAGE_STRUCTURE.md §15 Public Protocols](./PACKAGE_STRUCTURE.md)
- [GLOSSARY.md](./GLOSSARY.md)
- [TESTING_STRATEGY.md](./TESTING_STRATEGY.md)
- [docs/adr/](./docs/adr/)
- [SECURITY.md §3 Provider Secrets](./SECURITY.md) — for inference providers
