...
- The integration tests measure p50/p99 latency on a 20-field contract as a baseline (see [PRD §9](https://github.com/nexusnv/paxman-wiki/blob/main/Internal-Development/PRD.md) for targets).
