...
- [AGENTS.md:73](https://github.com/nexusnv/paxman/blob/main/AGENTS.md) — "MONEY first-class: amount + ISO-4217 currency + precision (Decimal, never float)".
- [docs/sprints/sprint-07a-budget-money-decimal.md](https://github.com/nexusnv/paxman-wiki/blob/main/Internal-Development/Sprints.md) — the intervention sprint that implements this ADR.
