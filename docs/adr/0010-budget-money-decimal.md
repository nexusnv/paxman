...
- [AGENTS.md:73](../../AGENTS.md) — "MONEY first-class: amount + ISO-4217 currency + precision (Decimal, never float)".
- [docs/sprints/sprint-07a-budget-money-decimal.md](../../sprints/sprint-07a-budget-money-decimal.md) — the intervention sprint that implements this ADR.
- [docs/specs/capability-cost-model.md](../../specs/capability-cost-model.md) — the cost model refined by this refactor.
- [CHANGELOG.md](../../CHANGELOG.md) — entry added under `[Unreleased]`.
- [src/paxman/budget.py](../../src/paxman/budget.py) — the primary type being changed.
- [src/paxman/artifact/statistics.py](../../src/paxman/artifact/statistics.py) — the terminal type whose `Decimal` declaration is no longer aspirational after this ADR.
