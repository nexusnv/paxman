...
> **Status:** Active.
> **Related docs:** [ARCHITECTURE.md](./../ARCHITECTURE.md), [PACKAGE_STRUCTURE.md](./../PACKAGE_STRUCTURE.md), [GLOSSARY.md](./../GLOSSARY.md)
...
| [0008](./0008-license-decision.md) | License Decision | Accepted | 2026-06-22 | MIT chosen for V1. Apache-2.0 is the documented alternative if patent concerns emerge. See [`docs/specs/license-decision.md`](../specs/license-decision.md) for the full trade-off analysis. |
