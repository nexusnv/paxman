...
| [0008](./0008-license-decision.md) | License Decision | Accepted | 2026-06-22 | MIT chosen for V1. Apache-2.0 is the documented alternative if patent concerns emerge. The full trade-off analysis is preserved on the [project wiki](https://github.com/nexusnv/paxman-wiki/blob/main/Internal-Development/Decision-History/License-decision-full-analysis.md). |
