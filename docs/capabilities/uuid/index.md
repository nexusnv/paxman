...
The UUID capability is the second built-in capability shipped with Paxman v2. It canonicalizes strings into the RFC 4122 §3 36-char canonical form (the supported legacy profile; RFC 9562 is the current authority).
