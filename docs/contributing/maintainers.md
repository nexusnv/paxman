...
preferences. For contribution workflow, see [`CONTRIBUTING.md`](./index.md). For
security disclosures, see [`SECURITY.md`](../security/index.md).
...
| **`security@nexusnv.net`** | **Security vulnerabilities only** (per [`SECURITY.md`](../security/index.md)) |
...
address is reserved for security vulnerabilities only** (per [`SECURITY.md`](../security/index.md)).
...
- [`CONTRIBUTING.md`](./index.md) — contribution workflow
- [`SECURITY.md`](../security/index.md) — security policy and disclosure process
