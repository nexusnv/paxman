...
> **Related docs:** [TESTING_STRATEGY.md](./testing-strategy.md), [DEVELOPMENT.md](./development.md), [EXTENDING.md](../reference/extending.md), [SECURITY.md](../security/index.md), [DEPENDENCIES.md](../reference/dependencies.md)
...
| Test type (from [TESTING_STRATEGY.md §1](./testing-strategy.md)) | Data layer used |
|---|---|
...
**Policy:** V1 vendors only MIT, Apache-2.0, BSD, CC0, and CC-BY (non-SA) datasets. See [DATASET_LICENSES.md](https://github.com/nexusnv/paxman/blob/main/tests/fixtures/DATASET_LICENSES.md) for the full list.
...
See [SECURITY.md §2 PII Handling Defaults](../security/index.md) for the broader policy.
...
10. **Update docs.** Update [TESTING_STRATEGY.md](./testing-strategy.md) and [V1_ACCEPTANCE_CRITERIA.md](https://github.com/nexusnv/paxman-wiki/blob/main/Internal-Development/V1-acceptance-criteria.md) if relevant.
...
The script is **the source of truth** for what's vendored. See [scripts/fetch_test_data.py](https://github.com/nexusnv/paxman/blob/main/scripts/fetch_test_data.py) for the full implementation spec.
...
These strategies are the foundation of [TESTING_STRATEGY.md §3 Property Tests](./testing-strategy.md).
...
**Important:** the golden artifacts are **versioned**. When the `ExecutionArtifact` schema changes, the golden artifacts are regenerated. See [REPLAY_AND_DETERMINISM.md §3 The Replay Protocol](../reference/replay-and-determinism.md) for the version-compatibility rules.
...
The full file is at [tests/fixtures/DATASET_LICENSES.md](https://github.com/nexusnv/paxman/blob/main/tests/fixtures/DATASET_LICENSES.md).
...
3. Verify that the field-resolution rate meets the success-metric target (≥ 90% in [PRD §9](https://github.com/nexusnv/paxman-wiki/blob/main/Internal-Development/PRD.md)).
...
- [TESTING_STRATEGY.md](./testing-strategy.md) — test seams, property tests, replay tests
- [DEVELOPMENT.md §5 Running Tests](./development.md) — running the test suite
- [SECURITY.md §2 PII Handling Defaults](../security/index.md) — PII policy for test data
- [EXTENDING.md](../reference/extending.md) — adding new adapters, capabilities, providers
- [REPLAY_AND_DETERMINISM.md](../reference/replay-and-determinism.md) — replay-equality tests
- [DEPENDENCIES.md](../reference/dependencies.md) — dev dependencies (faker, factory_boy, hypothesis, etc.)
- [tests/fixtures/DATASET_LICENSES.md](https://github.com/nexusnv/paxman/blob/main/tests/fixtures/DATASET_LICENSES.md) — full attribution catalog
- [scripts/fetch_test_data.py](https://github.com/nexusnv/paxman/blob/main/scripts/fetch_test_data.py) — download script
