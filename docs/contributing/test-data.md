...
10. **Update docs.** Update [TESTING_STRATEGY.md](./testing-strategy.md) and [V1_ACCEPTANCE_CRITERIA.md](https://github.com/nexusnv/paxman/wiki/Internal-Development/V1-acceptance-criteria) if relevant.
...
3. Verify that the field-resolution rate meets the success-metric target (≥ 90% in [PRD §9](https://github.com/nexusnv/paxman/wiki/Internal-Development/PRD)).
