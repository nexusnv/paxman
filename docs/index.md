...
- **Want to know what shipped** — see the capability specs: [Email](capabilities/email/index.md), [UUID](capabilities/uuid/index.md), [Date](capabilities/date/index.md), [Phone](capabilities/phone/index.md), [URL](capabilities/url/index.md), [Boolean](capabilities/boolean/index.md), [IP](capabilities/ip/index.md), [Country](capabilities/country/index.md), [Geolocation](capabilities/geolocation/index.md), and their changelogs.
