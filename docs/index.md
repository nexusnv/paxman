...
### Try the Jupyter Lab Playground in Docker Container

> **New in v1.1.0+**

Want to explore Paxman interactively without writing code from scratch? The [Jupyter Lab Playground in Docker Container](https://github.com/nexusnv/paxman/blob/main/playground/README.md) starts a Jupyter Lab environment with Paxman installed from source — notebooks cover contracts, all 10 V1 capabilities, replay, money, and budget/policy.
...
See the [`playground/README.md`](https://github.com/nexusnv/paxman/blob/main/playground/README.md) for details.
