...
- **Want to know what shipped** — see the [Email capability spec](capabilities/email/index.md), the [UUID capability spec](capabilities/uuid/index.md), the [Phone capability spec](capabilities/phone/index.md), the [URL capability spec](capabilities/url/index.md), the [Date capability spec](capabilities/date/index.md), the [Boolean capability spec](capabilities/boolean/index.md), the [IP capability spec](capabilities/ip/index.md), the [Money capability spec](capabilities/money/index.md), and the [Geolocation capability spec](capabilities/geolocation/index.md).
