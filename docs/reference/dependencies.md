...
> **Related docs:** [PACKAGE_STRUCTURE.md §17 Build and Packaging Strategy](./package-structure.md), [SECURITY.md](../security/index.md), [PRD.md §11 Dependencies and Assumptions](https://github.com/nexusnv/paxman-wiki/blob/main/Internal-Development/Decision-History/PRD.md)
...
See [SECURITY.md](../security/index.md) for the vulnerability reporting process.
...
- [PRD.md §11 Dependencies and Assumptions](https://github.com/nexusnv/paxman-wiki/blob/main/Internal-Development/Decision-History/PRD.md)
