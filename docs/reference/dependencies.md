...
> **Related docs:** [PACKAGE_STRUCTURE.md §17 Build and Packaging Strategy](./package-structure.md), [SECURITY.md](../security/index.md), [PRD.md §11 Dependencies and Assumptions](https://github.com/nexusnv/paxman/wiki/Internal-Development/Decision-History/PRD)
...
- [PRD.md §11 Dependencies and Assumptions](https://github.com/nexusnv/paxman/wiki/Internal-Development/Decision-History/PRD)
