...
> **Related docs:** [PRD.md](https://github.com/nexusnv/paxman-wiki/blob/main/Internal-Development/Decision-History/PRD.md), [ARCHITECTURE.md](./architecture.md), [PACKAGE_STRUCTURE.md](./package-structure.md)
...
**Ownership rule:** the **caller** owns the contract. Paxman never owns schemas, domain ontologies, or business standards. See [PRD.md §5.1](https://github.com/nexusnv/paxman-wiki/blob/main/Internal-Development/Decision-History/PRD.md).
...
- [PRD.md](https://github.com/nexusnv/paxman-wiki/blob/main/Internal-Development/Decision-History/PRD.md) — Has a one-line glossary in §16.
