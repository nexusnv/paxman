...
> **Related docs:** [ARCHITECTURE.md](./architecture.md), [GLOSSARY.md](./glossary.md)

This is the **stable mental model for the codebase**, derived from [ARCHITECTURE.md](./architecture.md). It reflects the V1 product definition: a **contract-driven, field-centric, deterministic normalization engine**.
