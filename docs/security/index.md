...
> **Related docs:** [PRD §15 Compliance and Data Privacy Notes](https://github.com/nexusnv/paxman-wiki/blob/main/Internal-Development/Decision-History/PRD.md), [ARCHITECTURE.md §13 Security and PII Model](../reference/architecture.md), [GLOSSARY.md](../reference/glossary.md)
...
- [PRD §15 Compliance and Data Privacy Notes](https://github.com/nexusnv/paxman-wiki/blob/main/Internal-Development/Decision-History/PRD.md)
...
- [EXTENDING.md](../reference/extending.md) — adding new inference providers
