...
The following table defines the baseline `CostHint` values for the five V1 capabilities. These values were established in [CHANGES_LOG.md §3.1](https://github.com/nexusnv/paxman/wiki/Internal-Development/CHANGES-LOG#31-sprint-0-design-closure--recommended-decisions).
