...
- Linux (x86_64)
- (Manual smoke tests by 3 engineers per D9.12, or CI matrix if applicable)

Detailed verification results: [`cross-platform-verification.md`](./cross-platform-verification.md) (when created)
