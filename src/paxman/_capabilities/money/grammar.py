...
# remain supported via the contract. Wrapped in MappingProxyType for runtime
# immutability (Law 1 + Law 2 — the symbol map is replay-affecting state).
_SYMBOL_TO_CODE: Mapping[str, str] = MappingProxyType(
    {
        "$": "USD",
        "US$": "USD",
        "CA$": "CAD",
...
_SHARED_SYMBOL_CODES: Mapping[str, frozenset[str]] = MappingProxyType(
    {
        "C$": frozenset({"CAD", "NIO"}),
