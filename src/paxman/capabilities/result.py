...
class DiagnosticCode(enum.Enum):
    ...
    # V1.2.0: Real inference providers (spec #50 §6, plan 1/4 issue #51).
    # These codes map to specific Status values via the reconciler (ADR-0005).
    # INFERENCE_PROVIDER_KEY_MISSING/KEY_REFERENCE/MODEL_NOT_FOUND
    #   -> INVALID_CONTRACT (caller misconfiguration: env var not set,
    #      ref scheme unrecognized, or model id not served).
    # INFERENCE_PROVIDER_RATE_LIMITED/TIMEOUT/INVALID_RESPONSE/CAPABILITY_UNSUPPORTED
    #   -> runtime, default PARTIAL_SUCCESS.
    INFERENCE_PROVIDER_KEY_MISSING = "INFERENCE_PROVIDER_KEY_MISSING"
    INFERENCE_PROVIDER_KEY_REFERENCE = "INFERENCE_PROVIDER_KEY_REFERENCE"
    INFERENCE_PROVIDER_RATE_LIMITED = "INFERENCE_PROVIDER_RATE_LIMITED"
    INFERENCE_PROVIDER_TIMEOUT = "INFERENCE_PROVIDER_TIMEOUT"
    INFERENCE_PROVIDER_INVALID_RESPONSE = "INFERENCE_PROVIDER_INVALID_RESPONSE"
    INFERENCE_PROVIDER_MODEL_NOT_FOUND = "INFERENCE_PROVIDER_MODEL_NOT_FOUND"
    INFERENCE_PROVIDER_CAPABILITY_UNSUPPORTED = "INFERENCE_PROVIDER_CAPABILITY_UNSUPPORTED"
