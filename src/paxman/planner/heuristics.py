...
def has_explicit_evidence(
    ...
    Per the [Sprint 3 — Planner & capabilities](https://github.com/nexusnv/paxman-wiki/blob/main/Internal-Development/Sprints/Sprint-03---Planner-and-capabilities.md) (Oracle M7) and ``ARCHITECTURE.md`` §4.2, "explicit evidence"
