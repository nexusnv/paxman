...
The following fixtures are committed as of Sprint 2 (see the [Sprint 2 — Contract subsystem](https://github.com/nexusnv/paxman-wiki/blob/main/Internal-Development/Sprint-2-—-Contract-subsystem.md) for the implementation plan and exit criteria):
...
- [Sprint 2 — Contract subsystem](https://github.com/nexusnv/paxman-wiki/blob/main/Internal-Development/Sprint-2-—-Contract-subsystem.md) — Sprint 2 (when these fixtures landed).
