...
The following fixtures are committed as of Sprint 2 (see the [Sprint 2 — Contract subsystem](https://github.com/nexusnv/paxman/wiki/Internal-Development/Sprint-2-—-Contract-subsystem) for the implementation plan and exit criteria):
...
- [Sprint 2 — Contract subsystem](https://github.com/nexusnv/paxman/wiki/Internal-Development/Sprint-2-—-Contract-subsystem) — Sprint 2 (when these fixtures landed).
